...
function Library:create_ui()
    ...
    -- EDITED HERE: Changed transparency to 0.1 (Less transparent/Darker)
    ...
    function self:Update1Run(a)
        if a == "nil" then
            Container.BackgroundTransparency = 0.1; -- EDITED: Match the new default
        else
            pcall(function()
